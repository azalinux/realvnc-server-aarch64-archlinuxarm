...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-archlinuxarm/releases/download/realvnc-vnc-server-6.10.0/realvnc-vnc-server-6.10.0-1-aarch64.pkg.tar.xz
$ sudo pacman -U realvnc-vnc-server-6.10.0-1-aarch64.pkg.tar.xz
```
