...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-archlinuxarm/releases/download/realvnc-vnc-server-6.10.1/realvnc-vnc-server-6.10.1-1-aarch64.pkg.tar.xz
