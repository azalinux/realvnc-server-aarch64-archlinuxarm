...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-archlinuxarm/releases/download/v7.6.1/realvnc-vnc-server-7.6.1-1-aarch64.pkg.tar.xz
$ sudo pacman -U realvnc-vnc-server-7.6.1-1-aarch64.pkg.tar.xz
```
